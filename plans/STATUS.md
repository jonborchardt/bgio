...
| [14.15](14.15-assign-damage-dialog-state-reset.md) | pending |  |  |  | 14.10 | AssignDamageDialog wipes user edits on every Board re-render. Surfaced by post-14.10 code review. |
