...
| [14.14](14.14-tsx-bgio-resolver.md) | pending |  |  |  | 10.1, 12.7, 14.11 | Surfaced by 14.11 F1: `npm run server:dev` fails because tsx 4.20 mis-resolves bgio subpath imports. Live networked playtest depends on this. |
