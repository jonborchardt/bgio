...
| [14.16](14.16-centermat-chief-othersphase.md) | done | claude | plan/14.16-centermat-chief-othersphase | 2026-04-29 | 14.3 | Done. Gate now reads "chief panel actually rendering" (`expanded('chief') && ctx.phase === 'chiefPhase'`); mat shows in othersPhase. |
