...
| [14.4](14.4-circle-editor-multi-resource.md) | done | claude | plan/14.4-circle-editor-multi-resource | 2026-04-28 | 03.1, 04.1, 04.5, 09.4 | Done. CircleEditor + Bank summary render every non-zero resource (gold always visible). |
...
| [14.11](14.11-networked-playtest.md) | done | claude | plan/14.11-networked-playtest | 2026-04-29 | 10.x, 12.7, 13.3, 14.1, 14.2 | Done. plans/14.11-networked-playtest-findings.md captures F1 (server boot blocked by tsx subpath resolver) + static observations + resume steps. Live run blocked on 14.14. |
| [14.14](14.14-tsx-bgio-resolver.md) | done | claude | plan/14.14-tsx-bgio-resolver | 2026-04-29 | 10.1, 12.7, 14.11 | Done. Swapped tsx → vite-node for server runner; new server/start.ts entry; Dockerfile + docs updated. `npm run server:dev` boots cleanly. |
...
| [14.15](14.15-assign-damage-dialog-state-reset.md) | in_progress | claude | plan/14.15-assign-damage-dialog-state-reset | 2026-04-29 | 14.10 | AssignDamageDialog wipes user edits on every Board re-render. Surfaced by post-14.10 code review. |
