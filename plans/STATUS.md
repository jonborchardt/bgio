...
| [14.12](14.12-active-seat-header.md) | in_progress | claude | plan/14.12-active-seat-header | 2026-04-28 | 09.1, 14.1 | Header reads from ctx.activePlayers, not ctx.currentPlayer. Surfaced by post-14.1/14.2 smoke. |
