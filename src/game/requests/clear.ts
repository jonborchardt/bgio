...
//
// Called from the completion sites (scienceLibraryBuy, domesticBuyBuilding,
// defenseBuyAndPlace, *PlayTech) so a request auto-disappears the moment
// the requester actually performs the action, regardless of how the
// inputs got there.
