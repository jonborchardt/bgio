// Per-kind SVG glyphs. Each card kind gets a visually distinct
// silhouette: building / village / unit / army / science / tech. Glyphs
// are stroke-only by default (`filled={true}` to fill at low opacity)
// and recolour via `currentColor` so callers control colour through sx.

import { Box } from '@mui/material';

/** Card kinds the v9 design distinguishes visually. The "placed" /
 *  "army" / "grant" variants pick a slightly different glyph from the
 *  same family — same role, but the silhouette tells you whether
 *  this is a single instance or a placed/multi instance. */
...
const PATHS: Record<CardKind, { viewBox: string; d: string; extra?: string }> = {
  building: {
    viewBox: '0 0 32 32',
